...
SVG_USE_SPRITE = (
    '<svg class="{css_class}" aria-hidden="true" stroke-width="{stroke}" fill="none" stroke-linecap="round"  stroke-linejoin="round" stroke="currentColor"><use href="#{name}"></use></svg>'
)
SVG_SPRITES = (
...
@register.inclusion_tag('icons/tool-icon.html')
